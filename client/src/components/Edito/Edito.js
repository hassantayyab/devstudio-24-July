        ...
        <form onSubmit={ this.handleSubmit }>
          <div className="row">
            <div className="col">
              ...
              <input autoFocus name="backgroundImage1" autoFocus onChange={ this.handleChange } required type="url" className="form-control" placeholder="Enter background image url" />
            </div>
            <div className="col">
              <label htmlFor="backgroundImage">Background Image</label>
